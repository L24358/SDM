'''
Plot nullcline in which population 1 is favored.
...
res = hpr.get_nullcline_u2(51.2, 0.6, x0, params, 2)
s1 = res[0]; s2 = res[1][0]
s1, s2 = hpr.sort_nullcline(s1, s2)
plt.plot(s1,s2,'k',linewidth=1.5)

res = hpr.get_nullcline_u2(51.2, 0.6, x0, params, 1)
s1 = res[0]; s2 = res[1][0]
s1, s2 = hpr.sort_nullcline(s1, s2)
...
plt.tight_layout()
plt.savefig(os.path.join(mother,'nullcline_favor1.png'), dpi=600); plt.clf()